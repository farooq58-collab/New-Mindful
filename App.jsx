...
function App() {
  ...
  React.useEffect(() => {
    const handleScroll = () => {
      const isPastHero = heroRef.current 
        ? heroRef.current.getBoundingClientRect().bottom <= 100 
        : window.scrollY > 500;
      
      const isBeforeFooter = footerRef.current 
            ...
            >
              ...
              <div className="aspect-video w-full bg-black">
                <video
                  ...
                  src="/Hero/Elevate your IELTS preparation with our Cambridge Certified IELTS Trainer! 💙 Why MindfulYou thr.mp4"
                  controls
                  autoPlay
                  playsInline
                />
